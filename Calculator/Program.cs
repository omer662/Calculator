...
namespace OOProject
{
    ...
    {
        static int pIndex = 0;
        static List<IOp> functions = new List<IOp>();
        static List<char> names = new List<char>();

        static int GetRootIndex(string str)
        {
            int rIndex = -1;
            int pNum = 0;
        ...
        static IOp NormalToTree(string str)
        {
        ...
        static IOp PolishToTree(string str)
        {
        ...
        static void NewFunction(string input)
        {
            char fName = input[5];
        ...
        static void ShowFunction(string input)
        {
            char fName = input[5];
            if (!names.Contains(fName))
        ...
        static void CalculateFunc(string input)
        {
            char fName = input[5];
            if (!names.Contains(fName))
                Console.WriteLine("Function not found.");
