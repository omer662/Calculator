...
namespace OOProject
{
    class DivOp : IOp
    {
        ...
        public DivOp(IOp op1, IOp op2, bool normal)
        {
            this.op1 = op1;
            this.op2 = op2;
            this.normal = normal;
        ...
        {
            return new DivOp(new MinusOp(new MulOp(op2, op1.GetDerivative()), new MulOp(op1, op2.GetDerivative())), new MulOp(op2, op2)).Clean();
        }
        ...
        public IOp Clean()
        {
            ...
            if (newOp1 is NumOp && newOp2 is NumOp)
                return new NumOp((int)new DivOp(newOp1, newOp2).Calculate(0));
            else if (newOp1 is NumOp && newOp1.Calculate(0) == 0)
                return new NumOp(0);
